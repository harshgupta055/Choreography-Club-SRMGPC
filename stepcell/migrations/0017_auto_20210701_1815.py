# Generated by Django 3.0.8 on 2021-07-01 12:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('stepcell', '0016_controlvolunteer_volunteer'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(upload_to='team/', validators=[django.core.validators.FileExtensionValidator(['jpg', 'png', 'jpeg'])])),
            ],
        ),
        ...
        migrations.AlterField(
            model_name='controlvolunteer',
            name='year',
            field=models.CharField(help_text='Volunteer year which we want to display', max_length=50),
        ),
    ]
